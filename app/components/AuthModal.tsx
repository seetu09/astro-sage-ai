          ...
          {isAuthenticated && view === "profile" ? (
            ...
            <>
              <button
                ...
                className="w-full py-3 mb-4 bg-white/5 border border-[var(--border-color)] rounded-lg text-[var(--text-primary)] font-medium hover:bg-white/10 transition-all flex items-center justify-center gap-3"
              >
