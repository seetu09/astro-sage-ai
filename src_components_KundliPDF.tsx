...
export default function KundliPDF({
  ...
  // PAID - Show report and download button
  return (
    <div className="mt-8 space-y-6">
      ...
      {/* Report Preview (hidden from view but captured for PDF) */}
      <div 
        ref={reportRef} 
      ...
      >
        ...
        <div className="text-center pt-6 border-t-2 border-gray-200 text-gray-400 text-xs">
          <p>✦ This report is generated by AstroVeda AI ✦</p>
