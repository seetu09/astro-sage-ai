  ...
  en: {
    ...
    pdf: {
      ...
      template: {
        ...
        doshaRemediesHeading: 'Remedies',
        doshaNeutralized: 'This dosha is balanced or neutralized by beneficial planetary combinations in your chart.',
        doshaNoDosha: 'No significant doshas were detected. Your planetary positions support harmonious growth across life areas.',
        doshaManglikDesc: 'Mangal Dosha arises when Mars occupies the 1st, 2nd, 4th, 7th, 8th, or 12th house from the Lagna or Moon. It can create obstacles in marriage and relationships, causing delays or challenges in partnerships. The intensity depends on Mars\' strength and house placement. With awareness and remedies, effects can be reduced or neutralized.',
        doshaManglikRemedy: 'Kumbh Vivah or Hanuman Puja; daily recitation of "Om Mangalaya Namaha" 108 times; wear red coral on Tuesday; feed a red-faced cow on Tuesdays; donate red lentils and jaggery.',
        doshaSadeSatiDesc: 'Sade Sati occurs when Saturn transits the 12th, 1st, and 2nd houses from your Moon sign for ~7.5 years. This period brings discipline, karmic lessons, and responsibility, often with delays and obstacles. Three phases: Phase 1 (subtle preparation in the 12th), Phase 2 (peak intensity — Moon conjunct Saturn), Phase 3 (challenges easing in the 2nd). It calls for patience, spiritual practice, and inner resilience.',
        doshaSadeSatiRemedy: 'Recite Shani Chalisa daily (especially Saturdays); chant "Om Sham Shanicharaya Namah" 108 times; donate black sesame, iron, and dark cloth on Saturdays; fast on Saturdays; worship Lord Hanuman for protection.',
        doshaKaalSarpDesc: 'Kaal Sarp Dosha occurs when all planets are positioned between Rahu and Ketu, creating a "serpent embrace." This can cause stagnation, confusion, karmic obstacles, and delays in career, relationships, and life progress.',
        doshaKaalSarpRemedy: 'Perform Puja at a Nag temple on Nag Panchami; chant "Om Jalamindraya Namaha" 108 times daily; wear an emerald (if benefic) or blue sapphire (if malefic); offer milk and betel leaves to snake idols.',
        dashaMeaningHeading: 'Dasha Period Meaning',
        dashaMeaningKetu: 'Emphasizes spiritual pursuits, detachment, and introspection. A time to dissolve old patterns, meditate, and tie up karmic loose ends.',
        dashaMeaningVenus: 'Brings harmony, creativity, beauty, and wealth. Relationships, arts, luxury, and material comforts flourish.',
        dashaMeaningSun: 'Highlights leadership, authority, and self-expression. A time to take center stage, build reputation, and assert independence.',
        dashaMeaningMoon: 'Focuses on emotions, intuition, and nurturing. Relationships with mother and family are prominent; mental well-being is key.',
        dashaMeaningMars: 'Brings energy, courage, and drive. A dynamic period for action, competition, and overcoming obstacles through willpower.',
        dashaMeaningRahu: 'A transformative, restless period. Sudden changes, new technologies, foreign connections, and unconventional paths emerge.',
        dashaMeaningJupiter: 'A highly auspicious period. Growth in wisdom, education, children, and prosperity. Expansion through travel and higher learning.',
        dashaMeaningSaturn: 'Emphasizes discipline, responsibility, and karmic reckoning. Long-term structures, career, and authority are tested and built.',
        dashaMeaningMercury: 'A mentally active period. Communication, learning, commerce, and analytical work thrive. Adaptability and networking are key.',
        domainCareer: 'Career',
  ...
  hi: {
    ...
    pdf: {
      ...
      template: {
        ...
        doshaRemediesHeading: 'उपाय',
        doshaNeutralized: 'यह दोष आपकी कुंडली में लाभदायक ग्रह संयोजनों द्वारा संतुलित या निर्प्रभावी कर दिया गया है।',
        doshaNoDosha: 'कोई प्रमुख दोष नहीं पाया गया। आपके ग्रहों के स्थिति सभी जीवन क्षेत्रों में सामंजस्यपूर्ण विकास का समर्थन करते हैं।',
        doshaManglikDesc: 'मंगल दोष तभी उत्पन्न होता है जब मंगल लग्न या चंद्र से 1वें, 2वें, 4वें, 7वें, 8वें या 12वें भाव में हो। यह विवाह और संबंधों में बाधा उत्पन्न कर सकता है, साथी ढूंढने या संबंधों में चुनौतियों का कारण बन सकता है। तीव्रता मंगल की शक्ति और भाव स्थिति पर निर्भर करती है। जागरूकता और उपायों के साथ इसके प्रभावों को कम या निर्प्रभावी किया जा सकता है।',
        doshaManglikRemedy: 'कुंभ विवाह या हनुमान पूजा; रोज़ाना "ओम मंगलाय नमः" 108 बार जप करें; मंगलवार को लाल मूंगा पहनें; मंगलवार को लाल चमड़ी वाली बैल को खिलाएं; लाल दाल और गड़ी का दान करें।',
        doshaSadeSatiDesc: 'साढ़े सती तभी उत्पन्न होता है जब शनि आपके चंद्र राशि से 12वें, 1वें और 2वें भाव में लगभग 7.5 वर्षों तक संक्रमण करता है। यह अवधि अनुशासन, कार्मिक पाठ और ज़िम्मेदारी लाती है, अक्सर देरी और बाधाओं के साथ। तीन चरण: चरण 1 (12वें में सूक्ष्म तैयारी), चरण 2 (चंद्र और शनि के संयुक्त होने पर अधिकतम तीव्रता), चरण 3 (2वें में चुनौतियाँ कम हो रही हैं)। धैर्य, आध्यात्मिक अभ्यास और आंतरिक लचीलापन की आवश्यकता है।',
        doshaSadeSatiRemedy: 'शनिवार को रोज़ाना शनि चालीसा का पाठ; "ओम शां शनिचराय नमः" 108 बार जप करें; शनिवार को काली तिल, लोहा और काला कपड़ा दान करें; शनिवार उपवास रखें; सुरक्षा के लिए भगवान हनुमान की पूजा करें।',
        doshaKaalSarpDesc: 'काल सर्प दोष तभी उत्पन्न होता है जब सभी ग्रह राहु और केतु के बीच में स्थित होते हैं, जिससे एक "नाग आवली" बनती है। यह संकुचन, विचलन, कार्मिक बाधाएँ और करियर, संबंधों और जीवन की प्रगति में देरी ला सकती है।',
        doshaKaalSarpRemedy: 'नाग पंचमी पर नाग मंदिर में पूजा करें; "ओम जलामिंद्राय नमः" 108 बार दैनिक जप करें; यदि शुभ हो तो हीरा या यदि अशुभ हो तो नीलम पहनें; सर्प मूर्तियों को दूध और बेल के पत्ते चढ़ाएं।',
        dashaMeaningHeading: 'दशा अवधि का अर्थ',
        dashaMeaningKetu: 'आध्यात्मिक प्रवृत्तियों, विच्छेदन और अंतर्मुख अभ्यास पर ज़ोर। पुराने नक्शों को समाधान करने, ध्यान करने और कार्मिक बंधनों को मुक्त करने का समय।',
        dashaMeaningVenus: 'सामंजस्य, रचनात्मकता, सौंदर्य और धन का स्रोत। संबंध, कला, विलासिता और भौतिक सुविधाएँ फलती हैं।',
        dashaMeaningSun: 'नेतृत्व, प्राधिकार और आत्म- अभिव्यक्ति पर प्रकाश। केंद्र में आने, प्रतिष्ठा निर्माण और स्वतंत्रता का समय।',
        dashaMeaningMoon: 'भावनाओं, अंतर्ज्ञान और पोषण पर ध्यान। माँ और परिवार के साथ संबंध प्रमुख हैं; मानसिक कल्याण कुंज है।',
        dashaMeaningMars: 'ऊर्जा, साहस और प्रेरणा का स्रोत। कार्रवाई, प्रतिस्पर्धा और सशक्ति के माध्यम से बाधाओं को दूर करने का गतिशील समय।',
        dashaMeaningRahu: 'एक रूपांतरक, अशांत वक्र अवधि। अचानक परिवर्तन, नई तकनीकें, विदेशी संबंध और असामान्य पथ उभरते हैं।',
        dashaMeaningJupiter: 'एक अत्यंत शुभ अवधि। बुद्धि, शिक्षा, बच्चों और समृद्धि में विकास। यात्रा और उच्च शिक्षा के माध्यम से विस्तार।',
        dashaMeaningSaturn: 'अनुशासन, ज़िम्मेदारी और कार्मिक खाता खाने पर ज़ोर। दीर्घकालिक संरचनाएं, करियर और प्राधिकार परीक्षित और निर्मित हैं।',
        dashaMeaningMercury: 'एक मानसिक रूप से सक्रिय अवधि। संवादन, शिक्षा, व्यापार और विश्लेषणात्मक कार्य फलते हैं। अनुकूलन और नेटवर्किंग कुंज है।',
        domainCareer: 'करियर',
